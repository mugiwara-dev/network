...
/**
 * App — root component composing the 3D scene with UI overlays.
 */
    ...
    <div style={{
      ...
      {powerOnState === 'success' && activeTab === 'hardware' && (
        <div className="glass-panel success-popup" style={{
          ...
          padding: '16px 32px', zIndex: 50, animation: 'fadeInDown 0.5s ease both',
          border: '2px solid #10b981', background: 'rgba(16,185,129,0.1)',
          boxShadow: '0 0 20px rgba(16,185,129,0.4)'
        }}>
          <div style={{
            fontFamily: "'Orbitron', sans-serif", fontSize: '18px', fontWeight: 'bold',
            color: '#10b981', textTransform: 'uppercase', letterSpacing: '2px', textAlign: 'center'
          }}>
            🟢 System is now working
          </div>
          <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', color: '#a7f3d0', textAlign: 'center', marginTop: '6px' }}>
